<nav class="navbar navbar-expand-lg navbar-light shadow" style="background-color: ;">
    ...
    <h2 class="p-2 text-white" style="font-size:23px; font-weight:400;"><span class="fa-thin fa-book" style="margin-right: 3px;"></span>Books.com</h2>
        ...
        <ul class="navbar-nav d-flex align-items-end justify-content-end">
            <li class="nav-item">
                <a class="nav-link text-white {{ 'dashboard' == request()->path() ? 'active' : '' }}"
                    href="{{ '/dashboard' }}"><span class="fa-regular fa-table-columns"></span>Dashboard</a>
            </li>
            <li class="nav-item">
            ...
            @role('admin')
                ...
                <div class="dropdown">
                    <a class="btn dropdown-toggle text-warning bg-warning text-dark bg-opacity-75" type="button" id="dropdownMenuButton" data-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false"><span class="fas fa-lock"></span>
                        Admin
                    </a>
                    <div class="dropdown-menu bg-opacity-75 asd" style="background-color: black" aria-labelledby="dropdownMenuButton" id="select3">
