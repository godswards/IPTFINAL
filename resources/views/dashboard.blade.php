...
@section('content')
    <div class="container mt-3">
        <h1 class="text-center" style=" font-weight: 400; color:rgb(242, 226, 226); font-weight: bold; font-size: 100px;">Home</h1>
        <div class="content " style="position: relative; margin-left: 300px; margin-top: 150px">
                        ...
                        <a href="/recent-post" id="dash-link">
                            <div class="card-body rounded bg-warning" >
                                <div class="row">
                                    ...
                                    <div class="col mt-4">
                                        <span class="text-white float-right" id="text">Recent Book</span><br>
                    ...
                    <div class="card shadow">
                        <a href="/my-post" id="dash-link">
                            <div class="card-body rounded bg-warning">
                                <div class="row">
                                    <div class="col">
                                        <i class="fa fa-book mt-2" id="dash-icon"></i>
                                    </div>
                                    <div class="col mt-4">
                                        <span class="text-white" id="text">Your Books</span><br>
