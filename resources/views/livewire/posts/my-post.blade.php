        ...
        <div class="post-body">
            <div class="col-md-6" style="width: 560px">
                <div class=" shadow-md p-3 " id="write">
                    <button class="write-2 form-control bg-warning" style="color:white;background-color: ;" data-toggle="modal" data-target="#click">+ Create new book</button>
                </div>
            </div>
            ...
            <div class="col-md-10  offset-2">
                ...
                <div class="card shadow-md mt-3 {{ $post->user->gender === 'Female' ? 'f1' : 'm1' }}"  style="width: 900px">
                    ...
                    <div class="card-footer bg-dark">
                        ...
                        src="{{ $post->user->gender === 'Male' ? asset('images/god.jpg') : asset('images/asdf.jpg') }}"
                        alt="photo">
