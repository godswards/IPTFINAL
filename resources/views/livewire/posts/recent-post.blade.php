<div class="container col-md-12 ">
    ...
    <div class="profile">
        <h2 class="mt-3 text-white" style="font-weight: 400; font-size: 30px;">Recent Books</h2>
    </div>
    <div class="post-body">
        ...
        <div class="col-md-4">
            ...
            @endif
            <select class="form-select mb-1 bg-warning" style="background-color: " wire:model.lazy="title">
            ...
            <div class="card mt-3 {{ $recent->user->gender === 'Female' ? 'f1' : 'm1' }}" style="width: 900px">
                ...
                <div class="card-footer bg-dark">
                    ...
                    src="{{ $recent->user->gender === 'Male' ? asset('images/god.jpg') : asset('images/asdf.jpg') }}"
                    alt="photo">
