    ...
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content " id="modall">
        <div class="modal-header text-start">
            <h5 class="modal-title title1 text-secondary" id="exampleModalLabel">Creating book...</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
        <select name="title" class="form-select bg-warning" style="background-color: "  wire:model.defer="title">
