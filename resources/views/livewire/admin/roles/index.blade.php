<div>
    <div class="container mt-3">
        ...
        @endif
        <div class='btn btn-primary btn-sm float-end mb-2'  style="background-color: #FFA500; color:white;" data-toggle="modal" data-target="#modal-roles"> + Create New Role</div>
        ...
        <div class="card-body">
            <table class="table shadow-lg text-center">
                <thead style="background-color:#FFA500; color:black;">
                    <tr>
                        <th>Role</th>
                        <th>Action</th>
                    </tr>
